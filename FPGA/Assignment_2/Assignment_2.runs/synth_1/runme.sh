...
HD_PWD='C:/Electronics - Analog and Digital/ADI/FPGA/Assignment_2/Assignment_2.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log nand_zync_sys_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source nand_zync_sys_wrapper.tcl
