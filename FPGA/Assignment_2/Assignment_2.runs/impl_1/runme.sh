...
HD_PWD='C:/Electronics - Analog and Digital/ADI/FPGA/Assignment_2/Assignment_2.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log nand_zync_sys_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source nand_zync_sys_wrapper.tcl -notrace
