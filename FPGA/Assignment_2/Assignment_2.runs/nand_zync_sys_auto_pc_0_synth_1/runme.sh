...
HD_PWD='C:/Electronics - Analog and Digital/ADI/FPGA/Assignment_2/Assignment_2.runs/nand_zync_sys_auto_pc_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log nand_zync_sys_auto_pc_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source nand_zync_sys_auto_pc_0.tcl
