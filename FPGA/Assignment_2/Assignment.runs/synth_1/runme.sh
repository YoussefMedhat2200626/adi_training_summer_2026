...
HD_PWD='D:/Vivado_Projects/Assignment/Assignment.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log nand_zynq_sys_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source nand_zynq_sys_wrapper.tcl
