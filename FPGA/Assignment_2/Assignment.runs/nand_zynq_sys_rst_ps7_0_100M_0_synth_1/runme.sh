...
HD_PWD='D:/Vivado_Projects/Assignment/Assignment.runs/nand_zynq_sys_rst_ps7_0_100M_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log nand_zynq_sys_rst_ps7_0_100M_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source nand_zynq_sys_rst_ps7_0_100M_0.tcl
