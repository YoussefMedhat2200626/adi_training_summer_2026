...
HD_PWD='D:/Vivado_Projects/Assignment/Assignment.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log nand_zynq_sys_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source nand_zynq_sys_wrapper.tcl -notrace
