...
HD_PWD='D:/Vivado_Projects/Assignment/Assignment.runs/nand_zynq_sys_axi_gpio_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log nand_zynq_sys_axi_gpio_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source nand_zynq_sys_axi_gpio_0_0.tcl
