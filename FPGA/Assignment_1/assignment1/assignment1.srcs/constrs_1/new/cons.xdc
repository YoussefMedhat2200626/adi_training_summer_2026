...
create_generated_clock -name counter_clk \
 ...
 create_generated_clock -name clk_div_out_1Mhz \
        -source [get_pins u_pll/clk_out1] \
        -divide_by 8 \
        [get_pins u_clk_div/mod_counter_reg[2]/Q]

create_generated_clock -name clk_div_out_1hz \
    -source [get_pins u_pll/clk_out1] \
    -divide_by 8388608 \
    [get_pins u_clk_div/mod_counter_reg[22]/Q]
