...
HD_PWD='C:/Users/johns/Desktop/tasks/ADI/adi_training_summer_2026/fpga_labs/Assignment_2/project_2/project_2.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log nand_soc_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source nand_soc_wrapper.tcl -notrace
