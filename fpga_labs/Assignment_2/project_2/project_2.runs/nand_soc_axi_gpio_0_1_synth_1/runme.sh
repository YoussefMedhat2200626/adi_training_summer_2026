...
HD_PWD='C:/Users/johns/Desktop/tasks/ADI/adi_training_summer_2026/fpga_labs/Assignment_2/project_2/project_2.runs/nand_soc_axi_gpio_0_1_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log nand_soc_axi_gpio_0_1.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source nand_soc_axi_gpio_0_1.tcl
