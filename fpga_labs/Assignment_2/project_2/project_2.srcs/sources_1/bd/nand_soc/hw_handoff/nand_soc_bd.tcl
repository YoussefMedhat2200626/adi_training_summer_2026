...
################################################################
# This is a generated script based on design: nand_soc
#
...
proc create_root_design { parentCell } {
  ...
  set nand_out [ create_bd_port -dir O -from 0 -to 0 nand_out ]
  ...
  connect_bd_net -net a_0_1 [get_bd_ports in1] [get_bd_pins and_gate_0/a]
  connect_bd_net -net and_gate_0_y [get_bd_pins and_gate_0/y] [get_bd_pins axi_gpio_0/gpio_io_i]
  connect_bd_net -net axi_gpio_1_gpio_io_o [get_bd_ports nand_out] [get_bd_pins axi_gpio_1/gpio_io_o]
  connect_bd_net -net b_0_1 [get_bd_ports in2] [get_bd_pins and_gate_0/b]
